...
const { fetchApps, filterApps, searchApps, addUpvote } = require('../actions')
...
const Prefilters = require('../components/AppList/Prefilters')
const PrefilterButton = require('../components/AppList/PrefilterButton')
...
class AppList extends Component {
  ...
  applyPrefilter = filter => {
    this.props.dispatch(filterApps({
      countries: [],
      technologies: [],
      tags: filter.tags
    }))
  ...
  toggleUpvote = ev => {
    const { appid } = ev.currentTarget.dataset
    this.props.dispatch(addUpvote(appid))
  }
    ...
    return (
      <section className='homepage'>
        ...
        <div className='container'>
          ...
          <Prefilters>
            <PrefilterButton onClick={this.applyPrefilter} tags={['552f40333ec2bb03001dece1']} sort='upvotesCount' order='desc' text='Comunicación más accesible' />
            <PrefilterButton onClick={this.applyPrefilter} tags={['552ef4c2f7692f03000022a2']} sort='upvotesCount' order='desc' text='Transparentar presupuestos' />
            <PrefilterButton onClick={this.applyPrefilter} tags={['552f28bb3ec2bb03001deccd', '552ef3d1f7692f0300002291']} sort='upvotesCount' order='desc' text='Difundir legislación' />
            <PrefilterButton onClick={this.applyPrefilter} tags={['552ef3b0f7692f030000228e', '552f29e23ec2bb03001deccf', '552ef383f7692f030000228d', '552f2a193ec2bb03001decd0']} sort='upvotesCount' order='desc' text='Promover la participación ciudadana' />
            <PrefilterButton onClick={this.applyPrefilter} tags={['552ef4d0f7692f03000022a3', '55367179719aa70300d04489', '552f29b63ec2bb03001decce', '552ef4f0f7692f03000022a4', '552ef328f7692f030000228b']} sort='upvotesCount' order='desc' text='Visualización de datos' />
          </Prefilters>
