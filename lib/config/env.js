...
module.exports = {
  ...
  locale: env.LOCALE,
  client: env.CLIENT_CONF ? env.CLIENT_CONF.split(',') : [ "env", "locale", "organization name", "google analytics tracking id", "host", "languages" ],
  auth: {
    twitter: {
    ...
    disqus: {
      clientID: env.DISQUS_CLIENT_ID,
      clientSecret: env.DISQUS_CLIENT_SECRET
    }
  },
  secret: env.SECRET,
