...
app.use('/api', require('lib/license-api'));
...
app.use('/api', require('lib/technology-api'));
...
app.get('*', function(req, res) {
  var disqus = req.session && req.session.disqus ? req.session.disqus : {}
  var lang = req.cookies['lang'] || 'es'
  res.render('index', { config: config, t: t, disqus: disqus, lang: lang });
});
