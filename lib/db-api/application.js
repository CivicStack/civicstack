...
exports.all = function all(fn) {
  ...
  Application
  .find({ deletedAt: null })
  .select('id title logo backgroundColor description technology tags organization github website twitter license team contact workingAt partnership comments approved tagids')
  .populate('tags')
