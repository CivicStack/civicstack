...
exports.all = function all(fn) {
  ...
  Application
  .find({ deletedAt: null })
  .select('id name logo backgroundColor description technology technologyids tags organization github website country twitter license contact partnership comments approved tagids category')
  .populate('tags')
  .populate('category')
  .populate('country')
  .populate('license')
