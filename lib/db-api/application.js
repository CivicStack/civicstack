...
exports.all = function all(fn) {
  ...
  Application
  .find({ deletedAt: null })
  .select('id name logo backgroundColor description technology tags organization github website country twitter license contact partnership comments approved tagids')
  .populate('tags')
