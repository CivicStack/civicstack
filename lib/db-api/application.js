...
exports.all = function all(fn) {
  ...
  Application
  .find({ deletedAt: null })
  .select('id name logo backgroundColor video description technology technologyids tags organization github website country twitter license contact partnership comments approved tagids')
  .populate('tags')
  .populate('country')
  .populate('license')
  .populate('technology')
