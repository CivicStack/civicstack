...
page('/admin/apps/create', tags.middleware, countries.middleware, function (ctx, next) {
...
page('/admin/apps/:id', tags.middleware, countries.middleware, load, function (ctx, next) {
  var form = new AppForm({
    el: '.admin-content',
    replace: true,
    data: {
